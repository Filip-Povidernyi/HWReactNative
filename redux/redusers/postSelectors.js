export const selectPostCreate = (state) => state.post?.postCreate || { isLoading: false, error: null };
export const selectLastCreatedPost = (state) => state.post.postCreate?.lastPost;
export const selectLoading = (state) => state.post.postCreate?.isLoading;
...
export const selectCommentCreateLoading = (state) => state.post.commentCreate.isLoading;
export const selectCommentCreateError = (state) => state.post.commentCreate.error;